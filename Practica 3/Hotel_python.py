...
class Tipo_de_habitacion_de_habitacion(Enum):
    INDIVIDUAL = 1
    DOBLE = 2
    SUITE = 3
import os
...
class Hotel_reservaciones:
    def __init__(self):
        ...
        for Tipo_de_habitacion in Tipo_de_habitacion_de_habitacion:
        ...
        self.Tipo_de_habitacion_habitacion = Tipo_de_habitacion_de_habitacion(Tipo_de_habitacion_seleccionado)
    ...
    def Mostrar_info(self):
        ...
        print(f"Tipo de habitación: {self.Tipo_de_habitacion_habitacion.name}")
